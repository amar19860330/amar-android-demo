...
public class ExpandList5Activity extends Activity
{
    ...
    void afterViews()
    {
        listView = ( ExpandableStickyListHeadersListView ) findViewById( R.id.activity_stickylistheaders_listview );
        ...
        listView.setOnHeaderClickListener( new StickyListHeadersListView.OnHeaderClickListener()
        {
            ...
            //@Override
            public void onHeaderClick2( StickyListHeadersListView stickyListHeadersListView,View headView,int position,long headId,boolean b )
            {

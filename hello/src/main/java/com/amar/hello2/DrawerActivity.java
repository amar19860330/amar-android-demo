...
import com.amar.hello2.fragment.BookMarkerFragment;
import com.amar.hello2.fragment.ShowFragment;


public class DrawerActivity extends BaseActivity implements BookMarkerFragment.BookmarkListener
{
    ...
    {
        ShowFragment sf = ( ShowFragment ) DrawerActivity.this.getFragmentManager().findFragmentById( R.id.rightfragment );
